...
namespace LethalDungeon.ArchitectureTests
{
    public class ArchitectureTests
    {
        ...
        [TestCase("DungeonLayout", "DungeonLayoutTests.cs|DungeonLoopTests.cs|DungeonBranchLoopTests.cs|DungeonSeedTests.cs|DungeonExplorationBranchTests.cs|DungeonSpatialTests.cs", "MAP-")]
