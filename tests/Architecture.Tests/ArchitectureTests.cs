...
namespace LethalDungeon.ArchitectureTests
{
    public class ArchitectureTests
    {
        ...
        [TestCase("DungeonLayout", "DungeonLayoutTests.cs|DungeonLoopTests.cs|DungeonBranchLoopTests.cs|DungeonSeedTests.cs|DungeonExplorationBranchTests.cs|DungeonSpatialTests.cs|ConfiguredDungeonTests.cs|DungeonManyLoopsTests.cs|RandomDoorTests.cs", "MAP-")]
